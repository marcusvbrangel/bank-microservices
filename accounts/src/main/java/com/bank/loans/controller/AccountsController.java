...
import com.bank.loans.constants.AccountsConstants;
import com.bank.loans.dto.CustomerAccountDto;
import com.bank.loans.dto.CustomerDto;
import com.bank.loans.dto.ResponseErrorDto;
import com.bank.loans.dto.ResponseSuccessDto;
import com.bank.loans.service.AccountsService;
...
@Tag(
        ...
        description = "CRUD REST API in WolfBank to CREATE / READ / UPDATE / DELETE loans details"
)
